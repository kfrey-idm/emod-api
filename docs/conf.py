...
# Rename "emod-api" to "API reference"
...
autodoc_mock_imports = ['emod_api.dtk_tools']
...
html_baseurl = "https://docs.idmod.org/projects/emod-api/en/latest"
html_context = {
    'rtd_url': 'https://docs.idmod.org/projects/emod-api/en/latest',
    "versions_dropdown": {
        "latest": "devel (latest)",
...
latex_documents = [
    (master_doc, 'emod-api-docs.tex', u'emod-api',
...
man_pages = [
    (master_doc, 'emod-api-docs', u'emod-api',
     [author], 1)
]
