...
class VaccineTest(CampaignTest):
    ...
    def setUpClass(cls) -> None:
        super().setUpClass()
        sv.schema_path = os.path.join(current_directory, 'data', 'config', 'input_generic_schema_waning.json')
    ...
    def test_as_file(self):
        ...
        self.assertEqual(ic['Acquire_Config']['class'], "WaningEffect")
    ...
    def test_as_event(self):
        ...
        self.assertEqual(ic_1['Mortality_Config']['class'], "WaningEffect")
        ...
        self.assertEqual(ic_2['Acquire_Config']['class'], "WaningEffect")
        ...
        self.assertEqual(ic_3['Transmit_Config']['class'], "WaningEffect")
        ...
        self.assertEqual(ic_4['Mortality_Config']['class'], "WaningEffect")
    ...
    def test_as_event_2(self):  # skip this test until we fix https://github.com/InstituteforDiseaseModeling/emod-api/issues/141
        ...
        self.assertEqual(ic_1['Acquire_Config']['class'], "WaningEffect")
        self.assertEqual(ic_1['class'], 'Vaccine')
        ...
        self.assertEqual(ic_2['Transmit_Config']['class'], "WaningEffect")
        self.assertEqual(ic_2['class'], 'Vaccine')
        ...
        self.assertEqual(ic_3['Mortality_Config']['class'], "WaningEffect")
        self.assertEqual(ic_3['class'], 'Vaccine')
